...
let พร็อกซีไอพีs = ['t.me/trust_bodong'];
			...
			if (!upgradeHeader || upgradeHeader !== 'websocket') {
				...
				switch (url.pathname) {
					...
					default:
						...
						const randomHostname = พร็อกซีไอพีs[Math.floor(Math.random() * พร็อกซีไอพีs.length)];
						const newHeaders = new Headers(request.headers);
						newHeaders.set('cf-connecting-ip', '1.2.3.4');
						newHeaders.set('x-forwarded-for', '1.2.3.4');
						newHeaders.set('x-real-ip', '1.2.3.4');
						newHeaders.set('referer', 'https://www.google.com/search?q=Bodongvless');
...
=================================</div>
<div style="text-align: center;">
  <a href="https://t.me/trust_bodong" target="_blank" style="text-decoration: none;">Contact Me: <button style="color: red; background-color: transparent; border: none;">Telegram</button></a>
</div>`;
